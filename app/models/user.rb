class User < ActiveRecord::Base
  ...
  validates :phone_number, presence: true, uniqueness: true, format: { with: /\A[789]\d{9}\z/ }
  ...
  has_many :accepted_pick_ups, class_name: 'PickUp', foreign_key: :ragpicker_id, dependent: :destroy
